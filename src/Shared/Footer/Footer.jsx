...
const Footer = () => {
    return (
        <footer className="px-4 lg:px-20 py-5 divide-y bg-orange-100 text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <img className="w-16" src="https://i.ibb.co/tpr560D/world-consumer-rights-day-illustration-with-shopping-cart.png" alt="" />
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            <a rel="noopener noreferrer" href="https://www.facebook.com/afrin.tisha.524934" title="Facebook" className="flex items-center p-1">
                            ...
                            <a rel="noopener noreferrer" href="https://www.instagram.com/tonoyadiya/?hl=en" title="Instagram" className="flex items-center p-1">
